...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<ProtoGeom3> toroid1(new ProtoToroid(Vec3f(0, 0, 0), Vec3f(0,90,0), Dim3f(.15, .15, .15),ProtoColor4f(.3, .4, .5, 1), 32, 32, 1.5, .25));
    
    std::unique_ptr<ProtoGeom3> toroid2(new ProtoToroid(Vec3f(0, 0, 0), Vec3f(15,0,0), Dim3f(1.3, 1.3, 1.3),ProtoColor4f(.9, .5, .4, 1), 25, 25, 1.5, .05));
    
    std::unique_ptr<ProtoGeom3> toroid3(new ProtoToroid(Vec3f(0, 0, 0), Vec3f(0,0,90), Dim3f(.6, .6, .6),ProtoColor4f(.9, .5, .4, 1), 25, 25, 1.5, .15));
    
    std::unique_ptr<ProtoGeom3> toroid4(new ProtoToroid(Vec3f(0, 0, 0), Vec3f(0,0,0), Dim3f(.3, .3, .3),ProtoColor4f(.6, .7, .9, 1), 32, 55, 1.5, .185));
    ...
    std::unique_ptr<ProtoGeom3> tube(new ProtoTube(Vec3f(0,0,0),Vec3f(0,0,0), ProtoDimension3f(1.5,1.5,1.5), ProtoColor4f(.6, .5, .7, .9), spline, .01, 12));
