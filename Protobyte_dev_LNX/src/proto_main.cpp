...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<ProtoGeom3> toroid1(new ProtoToroid(Vec3f(0, 0, 0), Vec3f(0,90,0), Dim3f(.15, .15, .15),ProtoColor4f(.3, .4, .5, 1), 22, 22, 1.5, .25));
    ...
    std::unique_ptr<ProtoGeom3> tube(new ProtoTube(Vec3f(0,0,0),Vec3f(0,0,0), ProtoDimension3f(1.5,1.5,1.5), ProtoColor4f(.6, .5, .7, 1.0), spline, .09, 36, ProtoTransformFunction(ProtoTransformFunction::SINUSOIDAL, ProtoTuple2f(.05, .6), 200), true));
